...
export const clients = [
	...
	{ slug: 'images/client-logos/university-st-thomas', name: 'University of St. Thomas'},
...
<PageLayout title={title}>
	...
	<Section>
		...
		If you couldn't tell by now, I'm also a bit of a nerd. I'm also a husband and a father (to a wife, son, and daughter who are just as nerdy) living in beautiful Minnesota. On the side I'm an avid PC gamer, dedicated hockey fan (go [Frost](https://www.thepwhl.com/en/teams/minnesota-frost)!), and an occasionally successful bard in my tabletop campaigns.
	...
	<Section>
		...
		From enterprise research sites to campaign takeovers to nonprofit rebuilds, I've worked across the full range of what "design engineer" can mean — sometimes leading the visual system, sometimes translating someone else's.
