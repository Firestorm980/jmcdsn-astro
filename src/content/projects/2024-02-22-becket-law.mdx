...
platforms:
    - WordPress
featured_image: /becket-law/Robert-Soto-Production-Stills_16.jpg
roles:
    - Design
    - Engineering
---
...
Getting there meant making real information-architecture decisions, not just technical ones. Deciding which attributes (court, case type, media type) actually mattered enough to surface as filters, and which would just add noise for someone trying to find a specific case quickly. That structure had to work for both Becket's own team managing hundreds of documents and a visitor who might only ever use the site once.

<Devices
	phone="/src/assets/images/posts/becket-law/becket-law-small.png"
	tablet="/src/assets/images/posts/becket-law/becket-law-medium.png"
	desktop="/src/assets/images/posts/becket-law/becket-law-large.png"
...
<Figure caption="Using a faceted search, cases on Becket Law are much easier to find for users." src="/src/assets/images/posts/becket-law/becket-law-cases.png" alt="Screenshot of the Becket Law cases search UI." width="1920" height="1080" />
...
Along with the usual refresh in design that usually accompanies these kind of projects, Becket Fund was interested in a few features to improve the user experience as well. Besides our search and filtering functions, effort was made to make sure the site was keyboard accessible.

Accessibility wasn't treated as a checklist item here. A resource like this often gets used in exactly the moments people can least afford friction, like a journalist or researcher trying to verify a citation on deadline. That context shaped small decisions throughout, like making citation formatting and case tracking as low-effort as possible rather than burying them in menus.

There are also great features for users like case tracking via email updates, case citation in multiple formats with the click of a button, and pages for high profile cases that help users quickly get information they need.
