...
technologies:
    ...
    - Google Maps API
company: Westwerk
featured_image: /mim/building-maincourtyard.jpg
---
...
<Devices
	phone="/src/assets/images/posts/mim/mim-small.png"
	tablet="/src/assets/images/posts/mim/mim-medium.png"
	desktop="/src/assets/images/posts/mim/mim-large.png"
	caption="The Music Instrument Museum website was designed to be responsive across all devices."
/>
...
<Figure caption="The new events calendar made it easy for editors and users to find things to attend at the museum." src="/src/assets/images/posts/mim/mim-events-calendar.png" alt="Screenshot of the Music Instrument Museum events calendar page." width="1280" height="800" />
