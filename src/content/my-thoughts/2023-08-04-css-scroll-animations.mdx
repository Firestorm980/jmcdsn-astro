...
This first one is [ Chrometober 2022](https://web.dev/chrometober-2022/). Scroll horizontally to “read” the book! Then, read up on[ how it was built](https://web.dev/building-chrometober/).
...
Some[ Apple inspired scrolling](https://codepen.io/jh3y/pen/MWzQvKK) as well!
...
Jhey pointed me to this one as well, which does a great job of visualizing some of the settings specifically for[ `animation-range`](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-range). Fun fact, even the numbered percentage on the progress bars is done with pure CSS 🤯.
